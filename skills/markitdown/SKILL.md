...
- Use `scripts/convert_literature.py` for literature folder conversion workflows

## Local Repository Docs

- `INSTALLATION_GUIDE.md` - detailed setup and dependency installation
- `QUICK_REFERENCE.md` - quick command cheatsheet
- `OPENROUTER_INTEGRATION.md` - OpenRouter API integration guide
- `SKILL_SUMMARY.md` - condensed skill capability summary
- `assets/example_usage.md` - end-to-end practical examples
