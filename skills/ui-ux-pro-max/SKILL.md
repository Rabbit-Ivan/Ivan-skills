...
Available stacks: `html-tailwind`, `react`, `nextjs`, `vue`, `svelte`, `swiftui`, `react-native`, `flutter`, `nuxtjs`, `nuxt-ui`
...
| `nuxtjs` | SSR, Nitro, routing, modules |
| `nuxt-ui` | Nuxt UI components, theming, accessibility |
